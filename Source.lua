...
gethui = gethui or get_hidden_gui or function()
	local success, coreGui = pcall(function() return cloneref(game:GetService("CoreGui")) end)
	if success and coreGui then
		return coreGui
	end
	return cloneref(game:GetService("Players")).LocalPlayer:WaitForChild("PlayerGui")
end;
